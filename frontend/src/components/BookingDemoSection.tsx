...
const SERVICES: ServiceDefinition[] = [
  { id: "corte-maquina-tesoura", name: "Corte máquina & tesoura", price: 40, durationMinutes: 40 },
  { id: "corte-navalhado", name: "Corte navalhado", price: 40, durationMinutes: 40 },
  { id: "corte-barba", name: "Corte & barba", price: 55, durationMinutes: 40 },
  { id: "corte-maquina", name: "Corte máquina", price: 35, durationMinutes: 40 },
  { id: "corte-barba-sobrancelha", name: "Corte & barba & sobrancelha", price: 55, durationMinutes: 40 },
  { id: "corte-pigmentacao", name: "Corte + pigmentação", price: 45, durationMinutes: 40 },
  { id: "so-barba", name: "Só barba", price: 20, durationMinutes: 30 },
  { id: "pezinho", name: "Pezinho", price: 10, durationMinutes: 10 },
  ...
  { id: "sobrancelha", name: "Sobrancelha", price: 10, durationMinutes: 10 },
];
